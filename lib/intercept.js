...
function restoreModuleProp(module, method) {
  if (module.__nock_originalProps && module.__nock_originalProps[method]) {
...
function restoreOverriddenClientRequest() {
  ...
  debug(`- http.ClientRequest original ${ restoreModuleProp(http, 'ClientRequest') ? 'not found' : 'restored'}`)
  debug(`- http.request original ${ restoreModuleProp(http, 'request') ? 'not found' : 'restored'}`)
  debug(`- http.get original ${ restoreModuleProp(http, 'get') ? 'not found' : 'restored'}`)
  debug(`- https.get original ${ restoreModuleProp(http, 'get') ? 'not found' : 'restored'}`)
  debug(`- https.request original ${ restoreModuleProp(http, 'request') ? 'not found' : 'restored'}`)
