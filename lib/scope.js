  ...
  function intercept(uri, method, requestBody, interceptorOptions) {
    ...
    function match(options, body, hostNameOnly) {
      ...
      function reqheaderMatches(key) {
        ...
        //  Note: we can use 'host' lower-case as we know that all header field names are lower-case.
        if(key === 'host'
    ...
    */
    ...
    var interceptor = {
      ...
      , reqheaders: common.headerKeysToLowerCase((options && options.reqheaders) || {})
      , reply: reply
