...
function Scope(basePath, options) {
  ...
  if (!(basePath instanceof RegExp)) {
    ...
    this.basePath =
      this.urlParts.protocol + '//' + this.urlParts.hostname + ':' + this.port
  }
}
...
Scope.prototype.pendingMocks = function pendingMocks() {
  ...
  var pendingInterceptorKeys = Object.keys(this.keyedInterceptors).filter(
    function(key) {
...
function define(nockDefs) {
  ...
  nockDefs.forEach(function(nockDef) {
    ...
    var method = nockDef.method.toLowerCase() || 'get'
    ...
    var body = nockDef.body || ''
    var options = nockDef.options || {}
