...
Interceptor.prototype.reqheaderMatches = function reqheaderMatches(
  ...
  // options.headers are pulled straight from ClientRequest so a header field value should
  // be a string or an array of strings eg. `set-cookie`, however, nothing enforces those types.
  // For the ease of comparing, we cast all values to strings.
