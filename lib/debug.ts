...
export const request_overrider = debuglog('nock:request_overrider') as DebugLoggerFunction
export const playback_interceptor = debuglog('nock:playback_interceptor') as DebugLoggerFunction
...
export const scopeDebuglog = (namespace: string) => debuglog(`nock:scope:${namespace}`)
